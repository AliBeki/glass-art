...
<div class="background-img-gallery">
    <div class="about-cont">
        <h2 class="heading2-style">Workshop</h2>
    </div>
</div>  
@endsection
...
<div>
    <h3 class="heading3-style">Tiffany's Glass Painting Technique</h3>
    <p class="text-cont text-center">Below is an example of a moisaic created using the tiffany glass painting technique.</p>
</div>
